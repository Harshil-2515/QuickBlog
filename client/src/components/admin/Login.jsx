...
const Login = () => {
  ...
  return (
    <div className='flex justify-center items-center h-screen'>
      <div className='w-full max-w-sm p-6 md:m-6 border border-primary/30 shadow-xl rounded-lg shadow-primary/15'>
...
// Create control feild here we need 2 state variables
// will make functional during backend