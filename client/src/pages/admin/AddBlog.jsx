  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <label htmlFor="image">
          <img src={!image ? assets.upload_area : URL.createObjectURL(image)} className='mt-2 rounded h-16 cursor-pointer' alt="" />
        ...
        <input type="text" placeholder='Type here' required className='w-full max-w-lg mt-2 p-2 border border-gray-300 outline-none rounded' onChange={e=>setSubTitle(e.target.value)} value={subTitile}/>
        ...
        <button type='submit' className='mt-8 w-40 h-10 text-sm bg-primary text-white cursor-pointer rounded'>Add Blog</button>
...
// using quill package for that editor for blog description